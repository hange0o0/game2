class HelpManager {
    ...
    public constructor() {
        ...
        this.helpObj['card'] = {
            ...
            list:[
                '卡牌分为[单位]和[法术]两种',
                '上阵[单位]卡牌后，系统会按卡牌属性派出对应兵种冲向对手，如果能冲破对方出生点，则会对敌方队伍生命造成伤害',
                ...
                '随着主城等级的提升，会出现更多未解锁的[单位]卡牌，投入指定的数量的金币即可解锁该卡牌',
                '[法术]卡牌可通过兑换获得，当集满数量' + CardManager.getInstance().maxSkill + '后，玩家可永久保有该卡牌',
                '如果[法术]卡牌没有集满指定数量，玩家也可以将其放入手牌，但出战后，即使该卡牌没有在对战中被使用，也会扣除相应的数量',
