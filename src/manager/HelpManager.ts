class HelpManager {
    ...
    public constructor() {
        ...
        this.helpObj['card'] = {
            ...
            list:[
                //'卡牌分为和[法术]两种',
                '上阵卡牌后，系统会按卡牌属性派出对应兵种冲向对手，如果能冲破对方出生点，则会对敌方总生命造成伤害',
                //'上阵[法术]卡牌后，系统会释放一次对应法术，法术效果由卡牌属性决定',
                '需要注意的是，只有通过手牌上阵的单位才能对敌方生命造成伤害，通过技能[召唤]出现的单位是具有持续时间且不能伤害敌方生命的',
                '卡牌类型分为：'+PKConfig.TYPENAME[1] + '、'+PKConfig.TYPENAME[2] + '、'+PKConfig.TYPENAME[3] +'，单位间克制关系为：' + PKConfig.TYPENAME[1] + '->'+PKConfig.TYPENAME[2] + '->'+PKConfig.TYPENAME[3]+ '->'+PKConfig.TYPENAME[1] ,
        ...
        this.helpObj['pk'] = {
            ...
            list:[
                ...
                '当玩家的能量大于等于18点且空场时，系统会自动为玩家上阵一张【'+SkillVO.getObject(501).name+'】。其效果为：' + SkillVO.getObject(501).des,
                '当玩家空场并且无任何手牌时，系统会自动为玩家上阵一张【'+SkillVO.getObject(502).name+'】。其效果为：' + SkillVO.getObject(502).des,
