    ...
    public constructor() {
        ...
        this.helpObj['pos'] = {
            ...
            list:[
                ...
                '玩家可使用[测试]功能对当前卡组进行测试，测试对手从自己的进攻/防守阵容中选取',
            ]
        }
        ...
        this.helpObj['atkPos'] = {
            ...
            list:[
                ...
                '对战中，玩家手牌数量固定为'+PKConfig.maxHandCard+'张，当手牌数量不足时，会随机从[阵容牌库]中抽取卡牌进行补充。当[阵容牌库]的卡牌被抽光时，将不会有新的卡牌加入手牌',
                '阵容中所有卡牌以[6个]为一组[按顺序]进行分组，只有在前一组卡牌全被放入手牌后，才会从下一组进行抽取，以此类推。由此，玩家能一定程度上对卡牌的出现顺序进行控制。',
        ...
        this.helpObj['posChoose'] = {
            ...
            list:[
                ...
                '每张卡牌最多可使用3次',
                '[法术]卡牌可通过兑换获得，当集满数量为[' + CardManager.getInstance().maxSkill + ']的卡牌后，玩家可[永久保有]该卡牌',
        ...
        this.helpObj['slave'] = {
            ...
            list:[
                ...
                '收服奴隶成功后，该奴隶获得[2小时]的保护时间，不能反抗或被抢夺',
                '当玩家被其它玩家收服后，可进行反抗，反抗成功则可解除奴隶关系，并获得[5分钟]的保护时间',
                '玩家只能有一个主人，但可以有多名奴隶，升级['+TecVO.getObject(3).name+']科技等级，可提升奴隶数量上限',
                '玩家也可自主选择释放自己的奴隶，腾出奴隶空位',
                '玩家可使用钻石增加自己/奴隶的保护时间，保护时间内的玩家，不可被攻击/反抗',
                '成为主人后，可跟据奴隶的生产效率，获得其20%的[生产金币]收益，最多只能积累[10小时]，收取间隔为[1小时]',
                '成为奴隶后，金币生产效率下降[20%]',
            ]
        }
        ...
        this.helpObj['hang'] = {
            title:'战役系统',
            list:[
                '玩家可从战役中[获取收益]，收益的数量/种类会随着通过战役的数量而得到提高',
        ...
        this.helpObj['card'] = {
            ...
            list:[
                '卡牌分为[单位]和[法术]两种',
                '上阵[单位]卡牌后，系统会按卡牌属性派出对应兵种冲向敌人，如果能[冲破]对方出生点，则会对敌方队伍生命造成伤害',
                ...
                '[血量：]出战士兵的属性，当血量为0时，该单位[死亡]',
                '[防御：]出战士兵的属性，能减少敌方士兵对其造成的伤害',
                '[移动速度：]出战士兵的属性，数值越大，移动越快',
                '[伤害：]出战士兵的属性，冲破对方出生点后对敌方[队伍生命]造成的伤害值，如果对方[队伍生命]生命为[0]，则取得战斗胜利',
                '[攻击力：]出战士兵的属性，数值越大，对敌方士兵的伤害越大',
                '[攻击间隔：]出战士兵的属性，每次攻击的间隔时间',
                '[攻击距离：]出战士兵的属性，攻击发出时与敌人的最大距离',
                '[生物体积：]出战士兵的属性，当战场中已方的生物体积之和大于等于' + PKConfig.maxMonsterSpace + '时，上阵卡牌暂停出兵',
                '[技能间隔：]出战士兵的属性，士兵拥有技能的触发时间间隔',
            ]
        }
        ...
        this.helpObj['pk'] = {
            ...
            list:[
                ...
                '当战斗卡牌被放入[出战区]时，都有[3秒]的准备时间，准备时间过后，卡牌即会生效。',
