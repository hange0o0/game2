    ...
    public constructor() {
        ...
        this.helpObj['card'] = {
            ...
            list:[
                ...
                '[法术]卡牌分为：'+PKConfig.SKILLTYPENAME[1] + '、'+PKConfig.SKILLTYPENAME[2] + '、'+PKConfig.SKILLTYPENAME[3]+ '、'+PKConfig.SKILLTYPENAME[4]+ '、'+PKConfig.SKILLTYPENAME[5]+ '、'+PKConfig.SKILLTYPENAME[6],
                ...
                '卡牌属性【费用】：上阵该卡牌需要的能量',
                '卡牌属性【传送次数】：[单位]卡牌在战斗中的出兵次数，达到数量后卡牌失效并移出',
                '卡牌属性【传送间隔】：[单位]卡牌的出兵间隔',
                '卡牌属性【持续时间】：[法术]卡牌的技能持续时间',
                '卡牌属性【施法间隔】：当[法术]卡牌触发多次时的触发间隔',
                '卡牌属性【血量】：[单位]卡牌中传送士兵属性，当血量为0时，该单位死亡',
                '卡牌属性【防御】：[单位]卡牌中传送士兵属性，能减少敌方士兵对其造成的伤害，可与队伍防御进行叠加',
                '卡牌属性【移动速度】：[单位]卡牌中传送士兵属性，数值越大，移动越快',
                '卡牌属性【伤害】：[单位]卡牌中传送士兵属性，冲破对方出生点后对敌方生命造成的伤害值，如果对方生命为0，则取得游戏胜利',
                '卡牌属性【攻击力】：[单位]卡牌中传送士兵属性，数值越大，对敌方士兵的伤害越大',
                '卡牌属性【攻击间隔】：[单位]卡牌中传送士兵属性，每次攻击的间隔时间',
                '卡牌属性【攻击距离】：[单位]卡牌中传送士兵属性，攻击发出时与敌人的最大距离',
                '卡牌属性【生物体积】：[单位]卡牌中传送士兵属性，当战场中已方的生物体积之和大于等于' + PKConfig.maxMonsterSpace + '时，上阵[单位]卡牌暂停出兵',
                '卡牌属性【技能间隔】：[单位]卡牌中传送士兵属性，所有的士兵都会具有技能，这里指每次触发其技能的间隔时间',
            ]
        }
